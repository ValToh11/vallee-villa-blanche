...
Côté visiteurs : voir l'appartement proposé à la location, se créer un compte, réserver des dates et payer en ligne.
...
je suis en pleine recherche d'alternance en Bachelor developpement Web IA

Je voulais un premier projet qui est utile à ma famille, et il me force à toucher à un peu tout.

04 - Comment c'est construit

PHP et MySQL pour le moteur, du HTML, du CSS et un peu de JavaScript pour les pages, le tout en local sur WampServer. Rien d'exotique : des bases solides que je veux d'abord maîtriser pour de vrai avant d'aller voir ailleurs.

Les couleurs et les polices viennent d'une petite charte maison : un blanc cassé, un vert sapin et un or sable, avec une serif élégante pour les titres.

05 - Où j'en suis

Ce que j'ai déjà fait :

[x] Le dépôt Git et l'environnement local en place
[x] La charte graphique en CSS
[x] La page d'accueil, avec en-tête et pied réutilisables

Ce qu'il me reste :

[ ] La carte des appartements et le catalogue
[ ] La base de données et l'affichage dynamique (PDO)
[ ] L'inscription et la connexion des clients
[ ] La réservation (sans chevauchement de dates) et le paiement
[ ] Les photos et les emails de confirmation
[ ] L'espace famille
...
VALLÉE Thomas, en reconversion vers le développement web, à la recherche d'une alternance.

GitHub : [@ValToh11](https://github.com/ValToh11) · Contact : [thomas.vallee0@gmail.com]
